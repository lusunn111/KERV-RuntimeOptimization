...
#from openvla.specdecoding.model.modeling_llama_kv import LlamaForCausalLM as KVLlamaForCausalLM

# 从本地模块导入GenerationMixin及其generate方法
...
from .modeling_speculation import LlamaSpecForCausalLM
...
class PrismaticCausalLMOutputWithPast(ModelOutput):
    ...
    # Additions for Speculations
    attention_mask : Optional[torch.BoolTensor] = None
    multimodal_labels : Optional[torch.BoolTensor] = None

class PrismaticPreTrainedModel(PreTrainedModel, LocalGenerationMixin):
...
class PrismaticForConditionalGeneration(PrismaticPreTrainedModel):
    def __init__(self, config: PrismaticConfig) -> None:
        ...
        if config.use_spec:
            print('loading customized speculative LM')
        ...
        #self.language_model = KVLlamaForCausalLM(
    ...
    def forward(
        ...
        if position_ids is not None:
            ...
            #print('tree verification finished')
            #print('input_ids',input_ids)
            #print('past_key_values',past_key_values)
            #print()
            #print('generation with cache finished'
        ...
        # === Handle Multimodal Forward ===
            ...
            #print('multimodal_forward return')
            #print(multimodal_attention_mask)
            return_multimodal_labels = multimodal_labels
            #print(return_multimodal_labels)
            #print(language_model_output.past_key_values)
            #print('multimodal forward finished')
...
class OpenVLAForActionPrediction(PrismaticForConditionalGeneration):
    # 保留这个print，这是表明类被加载的标志
    #print("OpenVLAForActionPrediction_new!!!!!!!!!!!!!!!!!!!!")
    ...
    def predict_action(
        ...
        **kwargs: str
        ...
        # Swallow speculative-only kwargs
